...
Используется сервер, расположенный в [репозитории](https://github.com/axer665/js-react-hooks-authentication-server), реализуйте приложение, удовлетворяющее следующим условиям:
